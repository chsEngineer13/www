...
<ol class="breadcrumb">
    ...
    <li class="active">Новые отчеты</li>
</ol>

<!-- Заголовок контента -->
<div class="content-header">
    <div class="content-title">Ссылки на отчеты для новой организации</div>
</div>
...
<form class="form-dialog form-dialog-md" role="form" autocomplete="off"
    action="{{ url("performance-dynamics/create") }}"  method="post">
    ...
    <div class="form-dialog-footer">
        ...
        <button type="submit" class="btn btn-primary"
            title="Создание ссылок на отчеты для новой организации">Создать</button>
    </div>
