...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('performance-dynamics') }}">Договоры</a></li>
    <li class="active">Новый</li>
</ol>

<!-- Заголовок контента -->
<div class="content-header">
    <div class="content-title">Новый договор</div>
</div>
...
<div style="margin-bottom: 20px">
    <ul class="nav nav-tabs">
        <li class="active"><a href="{{ url("contracts/new") }}" data-toggle="tab">Свойства</a></li>
    </ul>
</div>

<!-- Форма -->
<form class="form-dialog form-dialog-md" role="form" autocomplete="off"
    action="{{ url("contracts/create") }}"  method="post">
    ...
    <div class="form-dialog-footer">
        ...
        <button type="submit" class="btn btn-primary"
            title="Создание нового отчета">Создать</button>
    </div>
