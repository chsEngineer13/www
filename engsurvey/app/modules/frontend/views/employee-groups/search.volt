...
<div class="buttons-block">
    <a href="{{ url('employee-groups/new') }}" class="btn btn-default" title='Создание новой группы'>
    ...
    <tbody>
        {% for group in employeeGroups %}
            <tr>
                ...
                <td>
                    <a href="{{ url('employee-group-memberships?employee_group_id=' ~ group.getId()) }}">
                        {{ group.getName() }}</a>
                </td>
                <td>{{ group.getDescription() }}</td>
                <td>
                    <a href="{{ url('employee-groups/edit?id=' ~ group.getId()) }}" class="btn btn-primary btn-xs"
