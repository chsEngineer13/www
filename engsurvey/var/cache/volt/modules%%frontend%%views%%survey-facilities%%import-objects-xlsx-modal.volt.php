        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="importObjectsXlsxForm" class="form" method="POST" enctype="multipart/form-data"
                    action="<?= $this->url->get('survey-facilities/import-objects-xlsx' . '?construction-project-id=' . $constructionProject->getId() . '&construction-site-id=' . $constructionSite->getId()) ?>">
                    <fieldset>
