...
<div class="content-header">
    <div class="content-title">Редактирование участка работ</div>
</div>
...
<?= $this->tag->form(['construction-sites/update', 'class' => 'form-dialog form-dialog-md', 'role' => 'form', 'method' => 'post', 'autocomplete' => 'off']) ?>
