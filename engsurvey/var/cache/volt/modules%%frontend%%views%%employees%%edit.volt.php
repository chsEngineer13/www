...
<ol class="breadcrumb">
    ...
    <li><a href="<?= $this->url->get('employees') ?>">Сотрудники</a></li>
...
<form class="form-dialog form-dialog-md" role="form" autocomplete="off"
    action="<?= $this->url->get('employees/update') ?>"  method="post">
    ...
    <div class="form-dialog-footer">
        <a href="<?= $this->url->get('employees') ?>" class="btn btn-default" role="button"
