...
<div class="buttons-block">
    <a href="<?= $this->url->get('branches/new') ?>" class="btn btn-default" title='Создание нового филиала'>
    ...
    <tbody>
        <?php foreach ($branches as $branch) { ?>
            <tr>
                ...
                <td>
                    <a href="<?= $this->url->get('branches/edit?id=' . $branch->getId()) ?>" class="btn btn-primary btn-xs"
